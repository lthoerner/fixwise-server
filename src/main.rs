...
async fn main() {
    ...
    database::add_items(inventory_items, customers, tickets).await;
    ...
    let routes = Router::new()
        ...
        .route("/views/tickets", get(get_tickets_view))
        .layer(cors);
...
async fn get_tickets_view() -> Json<FrontendTableView> {
    get_json_file("./database/frontend_views/tickets.json")
}
